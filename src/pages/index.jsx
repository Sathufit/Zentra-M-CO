    ...
    <div className="min-h-screen bg-navy-950 text-white font-sans overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20">
            <div className="flex items-center">              <div className="flex-shrink-0">
                <div className="flex items-center gap-2 h-20 pl-2 pr-4">
                  <img
                    src="/images/logonew.jpeg"
                    alt="Zentra M & CO Logo"
                    className="h-16 w-auto object-contain"
                    style={{ background: 'white', maxHeight: '64px', maxWidth: '160px', borderRadius: '0.5rem' }}
                  />
                </div>
              </div>
            </div>
            ...
            <div className="-mr-2 flex md:hidden">
              <button
                ...
                className="inline-flex items-center justify-center p-2 rounded-md text-gray-300 hover:text-[color:var(--color-logo-gold)] focus:outline-none"
                aria-expanded="false"
              >
      ...
      <main className="pt-20">
        ...
        <section id="hero" className="relative overflow-hidden min-h-[100svh] flex flex-col justify-center">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-1 sm:w-1.5 bg-gradient-to-b from-transparent via-[color:var(--color-logo-gold)] to-transparent opacity-70" />
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-5 sm:px-10 lg:px-20 -mt-10 lg:-mt-0 pb-32 sm:pb-36 lg:pb-0">
            ...
            <div className="flex items-center gap-3 mb-4 sm:mb-6 lg:mb-8">
              <div className="h-px w-8 sm:w-12 bg-[color:var(--color-logo-gold)]" />
              <span className="text-[color:var(--color-logo-gold)] text-[10px] sm:text-xs font-bold tracking-[0.25em] uppercase">Sale, Victoria — Est. 2019</span>
            </div>
            ...
            <h1 className="font-black tracking-tight leading-none mb-4 sm:mb-6 lg:mb-8 max-w-4xl">
              ...
              <span className="block text-[color:var(--color-logo-gold)]" style={{ fontSize: 'clamp(2.4rem, 10vw, 6.5rem)', lineHeight: 1.05 }}>
                Property.
              </span>
            ...
            <div className="flex flex-wrap gap-4 items-center mb-8">
              <button
                onClick={() => scrollToSection('contact')}
                className="group relative overflow-hidden bg-[color:var(--color-logo-gold)] text-black px-7 sm:px-9 py-3.5 sm:py-4 rounded-xl text-sm sm:text-base font-bold shadow-xl shadow-[color:var(--color-logo-gold)]/20 hover:shadow-[color:var(--color-logo-gold)]/40 hover:scale-[1.02] transition-all duration-300"
              >
                <span className="relative z-10 flex items-center gap-2">
                  Get a Free Quote
                  <ArrowRight className="group-hover:translate-x-1 transition-transform duration-300" size={16} />
                </span>
                <div className="absolute inset-0 bg-[color:var(--color-logo-gold)]/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </button>

              <button
                onClick={() => document.getElementById('gallery')?.scrollIntoView({ behavior: 'smooth' })}
                className="group flex items-center gap-2 border border-white/20 hover:border-[color:var(--color-logo-gold)]/60 text-white px-6 sm:px-7 py-3.5 sm:py-4 rounded-xl text-sm sm:text-base font-semibold hover:bg-white/5 transition-all duration-300"
              >
                <Play size={15} className="text-[color:var(--color-logo-gold)]" />
                View Our Work
              </button>
            </div>
            ...
            <div className="flex flex-wrap gap-2.5">
              {[
                ...
                <div key={label} className="flex items-center gap-1.5 bg-white/5 border border-white/10 rounded-full px-3.5 py-1.5 text-xs sm:text-sm text-gray-300">
                  <Icon size={12} className="text-[color:var(--color-logo-gold)] shrink-0" />
                  {label}
                </div>
              ))}
            </div>
              ...
              <div className="grid grid-cols-3 md:grid-cols-6 divide-x divide-white/10 divide-y md:divide-y-0 divide-white/10">
                {[
                  ...
                  <button
                    ...
                    className="group flex flex-col items-center justify-center gap-1.5 py-3 sm:py-4 hover:bg-[color:var(--color-logo-gold)]/10 transition-colors duration-300"
                  >
                    <Icon size={16} className="text-[color:var(--color-logo-gold)] group-hover:scale-110 transition-transform duration-300 shrink-0" />
          ...
          <div className="absolute bottom-24 right-8 hidden lg:flex flex-col items-center gap-1 z-20">
            ...
            <ChevronDown className="text-[color:var(--color-logo-gold)]/50 animate-bounce" size={18} />
          </div>
        </section>
        {/* Services Section */}
        <section id="services" className="py-20 bg-navy-900 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              <div className="inline-flex items-center gap-2 bg-[color:var(--color-logo-gold)]/10 border border-[color:var(--color-logo-gold)]/25 rounded-full px-5 py-2 mb-5">
                <span className="text-[color:var(--color-logo-gold)] text-xs font-bold tracking-[0.18em] uppercase">What We Do</span>
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-6xl font-black mb-6">
                <span className="text-white">Our </span>
                <span className="bg-gradient-to-r from-[color:var(--color-logo-gold)] to-[color:var(--color-logo-gold)]/80 bg-clip-text text-transparent">Services</span>
              </h2>
            ...
            >
              {services.map((service, index) => {
                ...
                return (
                  ...
                  >
                    <div className="relative bg-navy-900 p-5 sm:p-8 rounded-3xl shadow-2xl border border-[color:var(--color-logo-gold)]/20 hover:border-[color:var(--color-logo-gold)]/50 transition-all duration-300 group-hover:scale-105 group-hover:shadow-[color:var(--color-logo-gold)]/10 overflow-hidden h-full">
                      ...
                      <div className="relative z-20">
                        <div className="bg-gradient-to-br from-[color:var(--color-logo-gold)] to-[color:var(--color-logo-gold)]/80 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:rotate-12 transition-transform duration-300 shadow-lg shadow-[color:var(--color-logo-gold)]/25">
                          <Icon className="text-black" size={24} />
                        </div>
                        <h3 className="text-2xl font-bold mb-4 text-white group-hover:text-[color:var(--color-logo-gold)] transition-colors duration-300">
                          {service}
                        </h3>
                      ...
                      {/* Top Border Gradient */}
                      <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[color:var(--color-logo-gold)] to-[color:var(--color-logo-gold)]/80 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500 z-20" />
                    </div>
                  </motion.div>
                );
              })}
        ...
        <section id="gallery" className="py-20 bg-navy-950 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl md:text-6xl font-black mb-6">
                <span className="bg-gradient-to-r from-[color:var(--color-logo-gold)] to-[color:var(--color-logo-gold)]/80 bg-clip-text text-transparent">
                  Our Gallery
                </span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            <motion.div
              ...
              className="relative aspect-[16/9] rounded-3xl overflow-hidden shadow-2xl border border-[color:var(--color-logo-gold)]/20"
            >
              ...
              <button
                onClick={prevSlide}
                className="absolute left-4 top-1/2 -translate-y-1/2 z-30 bg-black/50 hover:bg-[color:var(--color-logo-gold)] text-white hover:text-black p-3 rounded-full transition-all duration-300"
              >
                <ChevronLeft size={24} />
              </button>
              <button
                onClick={nextSlide}
                className="absolute right-4 top-1/2 -translate-y-1/2 z-30 bg-black/50 hover:bg-[color:var(--color-logo-gold)] text-white hover:text-black p-3 rounded-full transition-all duration-300"
              >
                ...
                {images.map((_, index) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition-all duration-300 ${
                      currentSlide === index
                        ? 'bg-[color:var(--color-logo-gold)] w-8'
        ...
        {/* Process Section */}
        <section className="py-20 bg-navy-950 text-white relative overflow-hidden border-t border-[color:var(--color-logo-gold)]/20">
          <div className="absolute inset-0 bg-gradient-to-br from-navy-950 via-navy-900/50 to-navy-950"></div>
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl md:text-6xl font-black mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-8">
              {[
                ...
                <div key={index} className="relative group">
                  <div className="bg-gradient-to-br from-navy-900 to-navy-950 p-5 sm:p-8 rounded-3xl border border-[color:var(--color-logo-gold)]/20 hover:border-[color:var(--color-logo-gold)]/40 transition-all duration-300 group-hover:scale-105 shadow-xl">
                    <div className="bg-gradient-to-br from-[color:var(--color-logo-gold)] to-[color:var(--color-logo-gold)]/80 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:rotate-12 transition-transform duration-300 shadow-lg shadow-[color:var(--color-logo-gold)]/25">
                      <step.icon className="text-black" size={24} />
                    </div>
                    <div className="absolute top-4 right-4 text-6xl font-black text-gray-800 group-hover:text-[color:var(--color-logo-gold)]/30 transition-colors duration-300">
        ...
        <section className="py-20 relative overflow-hidden border-t border-[color:var(--color-logo-gold)]/20" style={{ background: 'linear-gradient(135deg, #0a1628 0%, #1B2A6B 50%, #0a1628 100%)' }}>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative max-w-4xl mx-auto">
              <div className="bg-navy-900/80 backdrop-blur-lg rounded-3xl p-6 sm:p-8 md:p-12 border border-[color:var(--color-logo-gold)]/30 shadow-2xl">
                <div className="text-center">
                  <div className="flex justify-center mb-6">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="text-[color:var(--color-logo-gold)] fill-current" size={24} />
                    ))}
                  </div>
                  <Quote className="text-[color:var(--color-logo-gold)]/50 mx-auto mb-6" size={48} />
                  <p className="text-base sm:text-xl md:text-2xl font-light mb-8 leading-relaxed text-gray-100">
                    "{testimonials[activeTestimonial].text}"
                  </p>
                  <div className="flex items-center justify-center">
                    <div>
                      <h4 className="text-xl font-bold text-[color:var(--color-logo-gold)]">{testimonials[activeTestimonial].name}</h4>
                ...
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`h-2 rounded-full transition-all duration-300 ${
                      index === activeTestimonial ? 'bg-[color:var(--color-logo-gold)] w-8' : 'bg-white/30 w-2 hover:bg-white/60'
                    }`}
                  />
                ))}
              </div>
        ...
        {/* About Section */}
        <section id="about" className="py-20 bg-navy-950 text-white relative overflow-hidden border-t border-[color:var(--color-logo-gold)]/20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                  ...
                  {[
                    ...
                    <div key={index} className="space-y-2">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-[color:var(--color-logo-gold)] font-bold">{stat.value}</span>
                      </div>
                      <div className="w-full bg-navy-800 rounded-full h-3 overflow-hidden">
                        <div 
                          className="h-full bg-gradient-to-r from-[color:var(--color-logo-gold)] to-[color:var(--color-logo-gold)]/80 rounded-full transition-all duration-1000 ease-out shadow-lg shadow-[color:var(--color-logo-gold)]/25"
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-6">
                {[
                  ...
                  <div key={index} className="bg-navy-800 p-4 sm:p-6 rounded-2xl border border-[color:var(--color-logo-gold)]/20 hover:border-[color:var(--color-logo-gold)]/40 transition-all duration-300 group hover:scale-105 shadow-xl">
                    <feature.icon className="text-[color:var(--color-logo-gold)] mb-4 group-hover:text-[color:var(--color-logo-gold)]/80 transition-colors duration-300" size={32} />
        ...
        {/* Contact Section */}
        <section id="contact" className="py-20 relative overflow-hidden border-t border-[color:var(--color-logo-gold)]/20" style={{ background: 'linear-gradient(135deg, #060f1e 0%, #0d1f3c 100%)' }}>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center">
                    <div className="bg-[color:var(--color-logo-gold)]/10 border border-[color:var(--color-logo-gold)]/20 p-4 rounded-2xl mr-4">
                      <Phone className="text-[color:var(--color-logo-gold)]" size={24} />
                    </div>
                    <div>
                      <h3 className="font-bold text-white">Call Us</h3>
                      <a href="tel:+61414463184" className="text-gray-300 hover:text-[color:var(--color-logo-gold)] transition-colors duration-300">+61 414 463 184</a>
                    </div>
                  </div>
                  
                  <div className="flex items-center">
                    <div className="bg-[color:var(--color-logo-gold)]/10 border border-[color:var(--color-logo-gold)]/20 p-4 rounded-2xl mr-4">
                      <Mail className="text-[color:var(--color-logo-gold)]" size={24} />
                    </div>
                    <div>
                      <h3 className="font-bold text-white">Email Us</h3>
                      <a href="mailto:Info@zentram.com.au" className="text-gray-300 hover:text-[color:var(--color-logo-gold)] transition-colors duration-300">Info@zentram.com.au</a>
                    </div>
                  </div>
                  
                  <div className="flex items-center">
                    <div className="bg-[color:var(--color-logo-gold)]/10 border border-[color:var(--color-logo-gold)]/20 p-4 rounded-2xl mr-4">
                      <MessageSquare className="text-[color:var(--color-logo-gold)]" size={24} />
                    </div>
                    <div>
              ...
              <div className="bg-navy-900/60 backdrop-blur-lg p-5 sm:p-8 rounded-3xl border border-[color:var(--color-logo-gold)]/30 shadow-2xl">
                <h3 className="text-2xl font-bold text-[color:var(--color-logo-gold)] mb-6">Request a Quote</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 bg-navy-900 border border-navy-700 rounded-lg text-white focus:border-[color:var(--color-logo-gold)] focus:outline-none transition-colors duration-300"
                        ...
                        <label key={service} className="flex items-center cursor-pointer">
                          ...
                          <div className={`w-5 h-5 rounded border-2 mr-3 flex items-center justify-center transition-colors duration-300 ${
                            formData.servicesRequired.includes(service)
                              ? 'bg-[color:var(--color-logo-gold)] border-[color:var(--color-logo-gold)]'
                              : 'border-gray-600 hover:border-[color:var(--color-logo-gold)]'
                          }`}>
                            {formData.servicesRequired.includes(service) && (
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows="4"
                      className="w-full px-4 py-3 bg-navy-900 border border-navy-700 rounded-lg text-white focus:border-[color:var(--color-logo-gold)] focus:outline-none transition-colors duration-300 resize-none"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-[color:var(--color-logo-gold)] to-[color:var(--color-logo-gold)]/80 text-black py-4 px-8 rounded-lg font-bold hover:shadow-2xl hover:shadow-[color:var(--color-logo-gold)]/25 hover:scale-105 transition-all duration-300 relative overflow-hidden group"
                  >
                    <span className="relative z-10">Send Request</span>
                    <div className="absolute inset-0 bg-gradient-to-r from-[color:var(--color-logo-gold)]/80 to-[color:var(--color-logo-gold)] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  </button>
                </form>
              </div>
            </div>
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="flex flex-col items-center space-y-8">
              <motion.div
                ...
                className="bg-gradient-to-br from-[color:var(--color-logo-gold)] to-[color:var(--color-logo-gold)]/80 w-20 h-20 rounded-2xl flex items-center justify-center shadow-lg shadow-[color:var(--color-logo-gold)]/25"
              >
                {/* WhatsApp inline SVG */}
              ...
              <a
                ...
                className="group bg-gradient-to-r from-[color:var(--color-logo-gold)] to-[color:var(--color-logo-gold)]/80 text-black px-10 py-4 rounded-full text-lg font-bold hover:shadow-2xl hover:shadow-[color:var(--color-logo-gold)]/25 hover:scale-105 transition-all duration-300 inline-flex items-center space-x-3 relative overflow-hidden"
              >
        ...
        {/* Footer */}
        <footer className="bg-navy-900 text-white py-16 border-t border-[color:var(--color-logo-gold)]/20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
